...
#https://faker.readthedocs.io/en/master/locales/en_NZ.html
...
UserImport = f'TOTSPC202200101 - import {NumberOfRecords} New Zealand sites from {StartingNumber} to {SiteCode+NumberOfRecords-1}.csv'
...
with open(myfile, 'w', newline='') as csvfile:
    ...
    for n in range(1, NumberOfRecords+1):
        ...
        writer.writerow({'Site Code': SiteCode, 'Site Name': site_name, 'Primary Investigator Prefix': PI_Prefix, 'Primary Investigator First Name': PI_FirstName, 'Primary Investigator Last Name': fake.last_name(), 'Country': 'New Zealand', 'Time Zone': '(UTC+12:00) Auckland, Wellington', 'Primary Investigator Phone Number': user_phone(), 'Primary Investigator Email': PI_email, 'Site Mailing Address Attention': fake.name(), 'Site Mailing Address Street Address': fake.street_address(), 'Site Mailing Address Address Line 2': addr2, 'Site Mailing Address Address Line 3': addr3, 'Site Mailing Address City': fake.city(), 'Site Mailing Address State': "", 'Site Mailing Address Zip': fake.postcode(), 'Site Shipping Address Attention': fake.name(), 'Site Shipping Address Street Address': fake.street_address(), 'Site Shipping Address Line 2': addr2, 'Site Shipping Address  Line 3': addr3, 'Site Shipping Address City': fake.city(), 'Site Shipping Address State': "", 'Site Shipping Address Zip': fake.postcode(), 'Site Shipping Address Contact Title':  ship_Prefix, 'Site Shipping Address Contact First Name': ship_FirstName, 'Site Shipping Address Contact Last Name': ship_LastName, 'Site Shipping Address Contact Phone Number': user_phone(), 'Site Shipping Address Contact Email': shipping_email})
        SiteCode += 1
